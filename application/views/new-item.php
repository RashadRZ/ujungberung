                        ...
                        <div class="box-body">
                            <form id="form-insert-item" role="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kd_model" class="form-control" maxlength="4" placeholder="Kode model maksimal 4 digit
..." required />
                                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.bs-example-modal-sm').on('hidden.bs.modal', function () {
            ...
            $("#form-insert-item")[0].reset(); $(".bs-example-modal-sm input[name = 'kd_model']").val(null).attr("readonly", false);
